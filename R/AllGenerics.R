...
setGeneric("tnsPreprocess",
           function (tni, survivalData, keycovar, time = 1, event = 2, 
                     samples = NULL) standardGeneric("tnsPreprocess"), 
           package="RTNsurvival")
...
setGeneric("tnsKM",
           function (tns, regs = NULL, attribs=NULL, nSections=2, endpoint = 60, 
                     ...
                     xlab="Months", pal="redblue", excludeMid=FALSE, 
                     flipcols=FALSE, plotpdf=TRUE, plotbatch=FALSE, width = 6.3, 
...
setGeneric("tnsCox",
           function (tns, regs=NULL, endpoint=60, fname="coxplot", fpath=".", 
                     ...
                     xlab="Hazard Ratio (95% CI)", qqkeycovar=FALSE, 
                     excludeMid=FALSE, width=5, height=5, xlim=c(0.2,10), 
                     sortregs=TRUE, plotpdf = TRUE) 
